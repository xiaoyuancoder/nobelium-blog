...
export default function Post (props) {
  ...
  return (
    <article className={cn('flex flex-col', fullWidth ? 'md:px-24' : 'items-center')}>
      <h1 className={cn(
        'w-full font-bold text-3xl text-black dark:text-white text-center',
        { 'max-w-5xl px-4': !fullWidth }
      )}>
        {post.title}
      </h1>
      {post.type[0] !== 'Page' && (
          ...
          <div className="flex mb-4">
            <a href={BLOG.socialLink || '#'} className="flex">
              <Image
                ...
                width={24}
                height={24}
                src={`https://picimg.picktimehub.cn/file/iVwNtU6G.jpg`}
      ...
      <div className="self-stretch -mt-4 flex flex-col items-center lg:flex-row lg:items-stretch">
        ...
        <div className={fullWidth ? 'flex-1 pr-4' : 'flex-none w-full max-w-5xl px-4'}>
          <div className="notion-table-wrapper" style={{ overflowX: 'auto', width: '100%' }}>
